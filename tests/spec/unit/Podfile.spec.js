...
describe('unit tests for Podfile module', function () {
    ...
    describe('tests', function () {
        ...
        it('Test 011 : escapes multiple single quotes in project name when writing a Podfile', function () {
            podfile.before_install();

            var projectName = 'This project\'s name\'s';

            var expectedProjectName = 'This project\\\'s name\\\'s';
            var actualProjectName = podfile.escapeSingleQuotes(projectName);
